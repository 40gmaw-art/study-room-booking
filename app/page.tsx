      ...
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-3 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
        <section className="overflow-hidden rounded-[2rem] border border-[#4B3B71]/10 bg-white shadow-lg">
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            {/* This whole CTA row is student/guest-only -- an admin already has
                the admin nav above and needs neither student booking button. */}
            {!isAdmin ? (
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                {!isStudent ? (
                  ...
                  >
                    <Link href={isLoggedIn ? "/booking" : "/login"}>로그인하고 예약하기</Link>
                  </Button>
                ) : null}
                {/* A guest has no reservation to look up, so this only makes
                    sense once logged in as a student (admin is already
